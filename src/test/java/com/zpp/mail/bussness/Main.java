...
import com.zpp.mail.utils.ocr.CaptchaOCRUtil;
...
//    static ScheduledThreadPoolExecutor step1 = null;
    ...
    public static void main(String[] args) {
        ...
        loopCount = Integer.parseInt(InitPropertiesUtil.getInitProperty("main.thread.loop.max.count"));
...
class T1 implements Runnable{
    ...
    public T1(String eventId, String eventType) {
